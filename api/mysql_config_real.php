<?php
/**
 * IMPORTANTE: Este archivo requiere conexión REAL a la base de datos
 * Los datos simulados son solo para desarrollo - EN PRODUCCIÓN TODO DEBE VENIR DE LA BD
 */
    ...
    public static function connect() {
        if (self::$connection === null) {
            try {
                ...
                if (IS_LOCAL_DEV) {
                    error_log("VelaAroma DB: Error conexión local - usando datos simulados: " . $e->getMessage());
                } else {
